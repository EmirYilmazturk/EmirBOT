...
client.on('message', msg => {
  if (msg.content.toLowerCase() === 'botun güzelmiş efsane') {
    msg.reply('**Ne Sandın Yiğenim :wink:** ');
  }
});

client.on('message', msg => {
  if (msg.content.toLowerCase() === 'emirbot iyiymiş') {
    msg.reply('**Ne Sandın Yiğenim :wink:** ');
  }
});

client.on('message', msg => {
  if (msg.content.toLowerCase() === 'EmirBOT efsane') {
    msg.reply('**Ne Sandın Yiğenim :wink:** ');
  }
});

client.on('message', msg => {
  if (msg.content.toLowerCase() === 'EmirBOT efsanedir') {
    msg.reply('**Ne Sandın Yiğenim :wink:** ');
  }
});

client.on('message', msg => {
  if (msg.content.toLowerCase() === 'EmirBOT') {
    msg.reply('**He ??* ');
  }
});
...
client.on('message', msg => {
  if (msg.content.toLowerCase() === 'EmirBOT efso') {
    msg.reply('**Ne Sandın Yiğenim :wink:** ');
  }
});

client.on('message', msg => {
  if (msg.content.toLowerCase() === '<@510885930584899587>') {
    msg.reply('**Eğer Gereksiz Bişey İçin Etiketlediysen Vay Haline :D :gun::dagger:**');
  }
});
